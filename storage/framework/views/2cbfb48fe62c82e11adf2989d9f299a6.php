<?php $__env->startSection('title', 'Analytics Dashboard - Professional CMS'); ?>
        ...
        <aside class="w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 min-h-screen">
            <div class="p-4">
                <nav class="space-y-2">
                    ...
                    <a href="<?php echo e(route('subscriptions.index')); ?>" class="flex items-center space-x-3 px-3 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="<?php echo e(route('wallet.index')); ?>" class="flex items-center space-x-3 px-3 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="<?php echo e(route('messages.index')); ?>" class="flex items-center space-x-3 px-3 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg relative">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/>
                        </svg>
                        <span>Messages</span>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->receivedMessages()->where('is_read', false)->count() > 0): ?>
        ...
        <main class="flex-1 p-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 dark:text-white">$<?php echo e(number_format(((auth()->user()->wallet) ? auth()->user()->wallet->balance : 0), 2)); ?></p>
                            <p class="text-sm text-blue-600 dark:text-blue-400 mt-2">
                                <a href="<?php echo e(route('wallet.index')); ?>" class="hover:underline">View Wallet →</a>
                            </p>
                        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-sm text-indigo-600 dark:text-indigo-400 mt-2">
                                <a href="<?php echo e(route('subscriptions.index')); ?>" class="hover:underline">Manage →</a>
                            </p>
                        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $topPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                <div class="flex-1">
                                    <p class="text-sm font-medium text-gray-900 dark:text-white truncate"><?php echo e($post->title); ?></p>
                                    <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($post->created_at->diffForHumans()); ?></p>
                                </div>
                                <div class="flex items-center space-x-4 ml-4">
                                    <div class="text-right">
                                        <p class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e(rand(100, 5000)); ?></p>
                                        <p class="text-xs text-gray-500 dark:text-gray-400">views</p>
                                    </div>
                                    <div class="text-right">
                                        <p class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e(rand(10, 200)); ?></p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-sm font-semibold text-green-600 dark:text-green-400"><?php echo e(rand(50, 200)); ?></span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-sm text-gray-600 dark:text-gray-400">Current Page Views</span>
                            <span class="text-sm font-semibold text-blue-600 dark:text-blue-400"><?php echo e(rand(100, 500)); ?></span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-sm text-gray-600 dark:text-gray-400">Server Load</span>
                            <span class="text-sm font-semibold text-orange-600 dark:text-orange-400"><?php echo e(rand(20, 80)); ?>%</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    ...
                    <div class="space-y-3">
                        <a href="<?php echo e(route('subscriptions.index')); ?>" class="block w-full px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors text-center">
                            Manage Subscriptions
                        </a>
                        <a href="<?php echo e(route('wallet.index')); ?>" class="block w-full px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors text-center">
                            View Wallet
                        </a>
                        <a href="<?php echo e(route('messages.index')); ?>" class="block w-full px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors text-center">
                            Messages
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->receivedMessages()->where('is_read', false)->count() > 0): ?>
                                <span class="ml-2 bg-red-500 text-white text-xs rounded-full px-2 py-1">
                                    <?php echo e(auth()->user()->receivedMessages()->where('is_read', false)->count()); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/marcelo/Documents/cms-laravel/resources/views/dashboard-analytics.blade.php ENDPATH**/ ?>