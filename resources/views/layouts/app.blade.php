...
<head>
    ...
    <meta name="description" content="@yield('description', 'Un moderno sistema de gestión de contenido')">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center gap-8">
                    ...
                    <a href="{{ route('posts.index') }}" class="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition">Blog</a>
